...
const Index = () => {
  const services = [{
    ...
    icon: <img loading="lazy" decoding="async" src="/lovable-uploads/9cf6a4b9-25b1-4f9e-aed2-38b9da683a65.png" alt="Tree removal icon" className="h-10 w-10" />
  }, {
    ...
    icon: <img loading="lazy" decoding="async" src="/lovable-uploads/7bfbad7f-26f8-4ddd-8b39-934116e5f5c6.png" alt="Tree health assessment icon" className="h-10 w-10" />
  }, {
    ...
    icon: <img loading="lazy" decoding="async" src="/lovable-uploads/7b0ea919-918d-4b7d-8ebb-24c10ab9611d.png" alt="Emergency service icon" className="h-10 w-10" />
  }];
  const faqs = [{
            ...
            <div className="hidden lg:block bg-primary/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 space-y-8 lg:col-span-1">
              <div className="space-y-6">
                <div className="flex justify-start">
                  <img loading="lazy" decoding="async" src="/lovable-uploads/07200f5d-757d-4f85-8683-68ba4c9727e2.png" alt="Integra Tree Services" className="h-20 w-auto object-contain" />
                </div>
                <h1 className="font-serif text-3xl font-bold text-primary-foreground leading-tight md:text-4xl">
                Certified Arborist Tree Service in Surrey & the Lower Mainland
                </h1>
              ...
              <div className="pt-6 border-t border-primary-foreground/20">
                <div className="flex flex-wrap items-center gap-6 justify-start">
                  <img loading="lazy" decoding="async" src="/lovable-uploads/2247e1be-8c23-4b9b-b511-93e4c0be15fc.png" alt="ISA Certified Arborist" className="h-10 md:h-12 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                  <img loading="lazy" decoding="async" src="/lovable-uploads/c30af79e-b91d-4aea-9d97-54d047d8df24.png" alt="Pacific Northwest ISA" className="h-10 md:h-12 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                  <img loading="lazy" decoding="async" src="/lovable-uploads/e4e1ce49-14d4-4426-99bf-43aa0f8cd427.png" alt="ISA Member" className="h-10 md:h-12 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                </div>
              </div>
            </div>
            ...
            <div className="hidden md:block lg:hidden md:col-span-1 space-y-6">
              ...
              <div className="bg-primary/80 backdrop-blur-sm rounded-2xl p-6">
                <div className="flex flex-wrap items-center gap-4 justify-center">
                  <img loading="lazy" decoding="async" src="/lovable-uploads/2247e1be-8c23-4b9b-b511-93e4c0be15fc.png" alt="ISA Certified Arborist" className="h-10 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                  <img loading="lazy" decoding="async" src="/lovable-uploads/c30af79e-b91d-4aea-9d97-54d047d8df24.png" alt="Pacific Northwest ISA" className="h-10 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                  <img loading="lazy" decoding="async" src="/lovable-uploads/e4e1ce49-14d4-4426-99bf-43aa0f8cd427.png" alt="ISA Member" className="h-10 object-contain opacity-90 hover:opacity-100 transition-opacity" />
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-section-bg">
        <div className="container">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-6">Trusted Tree Service in Surrey, Delta, White Rock & Langley</h2>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              and dependable service. Whether you need tree removal in Surrey, an arborist in White Rock, or tree trimming in Langley, 
          ...
          <div className="relative h-96 md:h-[500px] mb-12">
            ...
            animationDelay: '0.1s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/ccbcc0cd-6161-49eb-a11e-d40b50ffdc11.png" alt="Professional arborist climbing tree" className="w-full h-24 md:h-32 object-cover rounded-lg" />
            ...
            animationDelay: '0.3s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/c1edb2c9-6bc1-4a66-aa3f-e88528b4b1c0.png" alt="Chainsaw and cut tree logs" className="w-full h-28 md:h-36 object-cover rounded-lg" />
            ...
            animationDelay: '0.5s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/7b53dd6c-81c4-41a5-9655-a419ada92841.png" alt="Jack and Doug with loaded truck" className="w-full h-32 md:h-40 object-cover rounded-lg" />
            ...
            animationDelay: '0.7s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/d44048bd-90cf-4db8-bc7f-662d0a52aaa2.png" alt="Tree climber in misty morning" className="w-full h-28 md:h-36 object-cover rounded-lg" />
            ...
            animationDelay: '0.9s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/3571f412-1815-42b4-85ee-32db22defd00.png" alt="Arborist on large tree trunk" className="w-full h-20 md:h-28 object-cover rounded-lg" />
            ...
            animationDelay: '1.1s'
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-36 md:w-44">
                <img loading="lazy" decoding="async" src="/lovable-uploads/f0bc9614-e096-4815-ac6a-82ab654d7a6a.png" alt="Team assessing tree work" className="w-full h-24 md:h-32 object-cover rounded-lg" />
